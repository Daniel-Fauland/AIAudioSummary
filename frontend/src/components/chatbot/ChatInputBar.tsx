  ...
  return (
    <div className="flex items-end gap-2 border-t border-border p-3">
      <textarea
        ...
        rows={1}
        className={cn(
          "flex-1 resize-none rounded-lg border border-border bg-card-elevated px-3 py-2 text-sm text-foreground placeholder:text-foreground-muted focus:outline-none focus:ring-1 focus:ring-primary disabled:opacity-50",
